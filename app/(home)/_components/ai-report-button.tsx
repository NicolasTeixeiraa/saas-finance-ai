        ...
        {hasProPlan ? (
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                Use inteligência artificial para gerar um relatório sobre suas
                finanças.
              </DialogDescription>
            </DialogHeader>
          ...
          <>
            <DialogHeader>
              <DialogTitle>Relatório IA</DialogTitle>
              <DialogDescription>
                Você precisa de um plano pro para gerar relatório com IA.
              </DialogDescription>
            </DialogHeader>
            <DialogFooter>
              <DialogClose asChild>
              ...
              <Button asChild>
                <Link href="/subscription">Assinar plano pro</Link>
              </Button>
            </DialogFooter>
          </>
        )}
